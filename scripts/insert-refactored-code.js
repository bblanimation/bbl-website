...
DomReady.ready(function() {
    ...
    social.innerHTML += '<li><a href="https://www.facebook.com/bblanimation/" target="_blank"><img class="social-icons" src="/images/social/facebook.png" alt="Facebook"></a></li>';
    social.innerHTML += '<li><a href="https://plus.google.com/+bigbudlego/" target="_blank"><img class="social-icons" src="/images/social/google+.png" alt="Google+"></a></li>';
    social.innerHTML += '<li><a href="https://www.youtube.com/c/bigbudlego" target="_blank"><img class="social-icons" src="/images/social/youtube.png" alt="YouTube"></a></li>';
    social.innerHTML += '<li><a href="https://www.linkedin.com/in/christopher-gearhart-16b902a3" target="_blank"><img class="social-icons" src="/images/social/linkedin.png" alt="LinkedIn"></a></li>';
    p.append(social);
