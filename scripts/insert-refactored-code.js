...
DomReady.ready(function() {
    ...
    social.innerHTML += '<li><a href="https://www.facebook.com/bblanimation/" onClick="_gaq.push([\'_trackEvent\', \'social_links\', \'click_link\', \'facebook\', \'0\']);" target="_blank"><img class="social-icons" src="/images/social/facebook.png" alt="Facebook"></a></li>';
    social.innerHTML += '<li><a href="https://plus.google.com/+bigbudlego/" onClick="_gaq.push([\'_trackEvent\', \'social_links\', \'click_link\', \'google+\', \'0\']);" target="_blank"><img class="social-icons" src="/images/social/google+.png" alt="Google+"></a></li>';
    social.innerHTML += '<li><a href="https://www.youtube.com/c/bigbudlego" onClick="_gaq.push([\'_trackEvent\', \'social_links\', \'click_link\', \'youtube\', \'0\']);" target="_blank"><img class="social-icons" src="/images/social/youtube.png" alt="YouTube"></a></li>';
    social.innerHTML += '<li><a href="https://www.linkedin.com/in/christopher-gearhart-16b902a3" onClick="_gaq.push([\'_trackEvent\', \'social_links\', \'click_link\', \'linkedin\', \'0\']);" target="_blank"><img class="social-icons" src="/images/social/linkedin.png" alt="LinkedIn"></a></li>';
    p.append(social);
